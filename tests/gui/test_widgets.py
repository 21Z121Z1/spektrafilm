...
def test_bounded_float_fields_use_slider_editor_and_unbounded_fields_use_spinbox(monkeypatch) -> None:
    ...
    monkeypatch.setitem(
        ...
        'slider_test',
        {
            'bounded': widget_specs_module.WidgetSpec(
                label='Bounded',
                tooltip='Bounded value',
                min_value=0.0,
                max_value=1.0,
                step=0.1,
                decimals=2,
            ),
            'too_many_steps': widget_specs_module.WidgetSpec(
                label='Too many steps',
                tooltip='Wide technical range',
                min_value=-100.0,
                max_value=100.0,
                step=0.25,
                decimals=2,
            ),
            'unbounded': widget_specs_module.WidgetSpec(
                label='Unbounded',
                tooltip='Unbounded value',
                min_value=0.0,
                step=0.1,
                decimals=2,
            ),
    ...
    assert isinstance(section.too_many_steps, widget_editors_module.FloatEditor)
