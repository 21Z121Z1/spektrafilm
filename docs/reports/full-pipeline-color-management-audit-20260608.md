...
- Audit smoke on
  `/Users/retriedstormtrooper/Downloads/03_图片素材/RAW_DNG照片/07_历史批量归档_DNG/IMG20240311182516.DNG`
...
.venv/bin/python tools/validate_profile_aware_hdr_raw_samples.py \
  --sample-dir "/Users/retriedstormtrooper/Downloads/03_图片素材/RAW_DNG照片" \
  --max-samples 1 \
